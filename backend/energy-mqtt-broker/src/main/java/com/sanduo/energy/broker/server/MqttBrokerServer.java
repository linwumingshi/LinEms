package com.sanduo.energy.broker.server;

import com.sanduo.energy.broker.config.BrokerProperties;
import com.sanduo.energy.broker.mqtt.KafkaEventProducer;
import com.sanduo.energy.broker.routing.KafkaTopicInitializer;
import com.sanduo.energy.broker.routing.RouterConsumer;
...
public class MqttBrokerServer {
     ...
     * TLS bootstrap 仅在 {@code sanduo.broker.tls.enabled=true} 时存在，用 {@link ObjectProvider}
