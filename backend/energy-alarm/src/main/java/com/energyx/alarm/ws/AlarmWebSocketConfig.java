 ...
 *
 * <p>
 * 网关 GlobalAuthFilter 对 /ws 前缀只放行升级请求，JWT 验签下沉到 {@link WsAuthInterceptor}（握手时校验 URL 查询参数
 * token，见 P0-2）； 直连本服务绕过网关的路径同样被拒。此处允许跨域以兼容本地前后端联调。
 * </p>
 */
@Configuration
@EnableWebSocket
public class AlarmWebSocketConfig implements WebSocketConfigurer {
	...
	public AlarmWebSocketConfig(AlarmWebSocketHandler alarmWebSocketHandler, WsAuthInterceptor wsAuthInterceptor) {
