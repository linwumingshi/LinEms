package com.energyx.alarm.mqtt;
...
/**
 * 告警侧 Kafka 生产者：发布 iot-alarm（告警事件，key=deviceId）。 idempotent producer（enable.idempotence +
 * acks=all），与 access/tsdb/shadow/command 参数一致。
 */
@Slf4j
@Component
