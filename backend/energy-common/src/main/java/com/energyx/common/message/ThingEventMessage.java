 ...
 *
 * <p>
 * 事件量远小于属性，统一投递；消费方：alarm（规则检测）、tsdb-writer（st_event 落库）、ws-pusher。 severity 对齐 TDengine
 * 定义：1提示 2一般 3严重 4危急，默认由物模型事件类型映射 （INFO→1 / WARN→2 / ERROR→3），设备显式携带时以设备值为准。
 * </p>
 */
@Data
