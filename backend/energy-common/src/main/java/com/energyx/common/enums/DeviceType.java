...
/** 设备类型（iot_device.device_type / iot_product.device_type，DB 存 code） */
public enum DeviceType {

	ENERGY_CABINET("ENERGY_CABINET", "储能柜"), BATTERY_CLUSTER("BATTERY_CLUSTER", "电池簇"), PCS("PCS", "PCS"),
	BMS("BMS", "BMS"), EMS("EMS", "EMS"), EDGE_GW("EDGE_GW", "边缘网关"), METER("METER", "进线电能表");
	...
	public static DeviceType fromCode(String code) {
		return Arrays.stream(values())
			...
			.findFirst()
			.orElseThrow(() -> new IllegalArgumentException("未知 DeviceType code=" + code));
	}
