...
public class ConditionalTenantLineHandler implements TenantLineHandler {
	...
	public static final Set<String> NO_TENANT_COLUMN_TABLES = Set.of("sys_tenant", "sys_user_role", "sys_permission",
			"sys_role_permission", "iot_device_certificate", "iot_device_group_relation", "iot_device_tag",
