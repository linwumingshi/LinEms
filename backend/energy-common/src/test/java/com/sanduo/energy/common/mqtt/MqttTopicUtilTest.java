...
class MqttTopicUtilTest {
    ...
    void buildClientId_shouldJoinWithUnderscore() {
        assertEquals("snd_ess_pcs_snd_pcs_001",
                MqttTopicUtil.buildClientId("snd_ess_pcs", "snd_pcs_001"));
    }
    ...
    void parseUpTopic_shouldParseAllFourTypes() {
        ...
        assertEquals(MqttUpType.EVENT,
                MqttTopicUtil.parseUpTopic("snd_ess_pcs/snd_pcs_001/up/event").upType());
        assertEquals(MqttUpType.LIFECYCLE,
                MqttTopicUtil.parseUpTopic("snd_ess_pcs/snd_pcs_001/up/lifecycle").upType());
        assertEquals(MqttUpType.ACK,
                MqttTopicUtil.parseUpTopic("snd_ess_pcs/snd_pcs_001/up/ack").upType());
    }
