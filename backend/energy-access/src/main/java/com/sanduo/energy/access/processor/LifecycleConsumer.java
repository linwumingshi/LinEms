...
import com.sanduo.energy.access.lifecycle.LifecycleProcessor;
...
/**
 * 设备生命周期消费（iot-device-lifecycle，key=deviceId）。
 * 委托 LifecycleProcessor 刷新设备在线态 + 上下线记录 + 离线指令补发。
 */
@Slf4j
@Component
public class LifecycleConsumer implements KafkaRecordHandler {
    ...
    public void handle(ConsumerRecord<String, String> record) {
        ...
        try {
            ...
            log.warn("[Access] lifecycle 反序列化失败 key={} offset={}，进 DLQ",
