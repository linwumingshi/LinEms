...
public class PermissionService {
	...
	public boolean hasRole(String role) {
		...
		return loginUser.getRoleCodes().contains(AuthConstants.SUPER_ADMIN) || loginUser.getRoleCodes().contains(role);
	}

	private boolean hasPermissions(Set<String> permissions, String permission) {
		return permissions.contains(AuthConstants.ALL_PERMISSION) || permissions.contains(permission.trim());
	}
