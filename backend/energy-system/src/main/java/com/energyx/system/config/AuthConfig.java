 ...
 *
 * <p>
 * 密码编码器使用 Spring Security 的 DelegatingPasswordEncoder（支持 {bcrypt}、 {noop} 等前缀），兼容 V1 种子数据
 * {noop}admin123，同时支持生产 BCrypt 哈希。
 * </p>
 */
@Configuration
public class AuthConfig {

	/** 绑定 energyx.jwt.* 配置（secret/expire-seconds/issuer） */
	@Bean
