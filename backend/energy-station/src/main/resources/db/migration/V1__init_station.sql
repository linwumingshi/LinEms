-- =====================================================================
-- 深圳三多能源储能管理平台 · station 域（energy-station 服务）
-- Flyway V1：电站资产 / 电站-设备关联
-- 说明：电站为资产树根（无 MQTT 接入）；设备实时状态权威源在 Redis（ADR-005）。
-- 幂等设计：IF NOT EXISTS（种子库与全新库均可执行）
-- =====================================================================
...
CREATE TABLE IF NOT EXISTS `iot_station_device` (
